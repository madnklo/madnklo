...
C     
C     Process: e+ e- > mu+ mu- a WEIGHTED<=6 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV1_1(W(1,4),W(1,5),GC_3,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,3),W(1,7),W(1,6),GC_3,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_4_0(W(1,3),W(1,7),W(1,8),GC_50,GC_59,AMP(4))
      CALL FFV1_1(W(1,1),W(1,5),GC_3,ZERO,ZERO,W(1,7))
      CALL FFV1P0_3(W(1,3),W(1,4),GC_3,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,7),W(1,8),GC_3,AMP(5))
      CALL FFV2_4_3(W(1,3),W(1,4),GC_50,GC_59,MDL_MZ,MDL_WZ,W(1,6))
C     Amplitude(s) for diagram number 6
      CALL FFV2_4_0(W(1,2),W(1,7),W(1,6),GC_50,GC_59,AMP(6))
      CALL FFV1_2(W(1,2),W(1,5),GC_3,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,7),W(1,1),W(1,8),GC_3,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_4_0(W(1,7),W(1,1),W(1,6),GC_50,GC_59,AMP(8))

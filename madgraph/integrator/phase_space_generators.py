...
class RustFlatInvertiblePhasespace(FlatInvertiblePhasespace):
    def __init__(self, *args, **opts):
        ...
        self.generator =  madnklo.FlatPhaseSpaceGenerator(len(self.initial_masses), (self.initial_masses, self.masses),
                self.collider_energy, self.beam_types, self.correlated_beam_convolution, self.is_beam_factorization_active)
    ...
    def get_PS_point(self, random_variables):
        ...
        PS_point, wgt, (xb_1, xi1) , (xb_2, xi2) = self.generator.get_PS_point(random_variables)
        return LorentzVectorList(PS_point), wgt, (xb_1, xi1) , (xb_2, xi2)

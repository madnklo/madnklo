...
# gl
        ...
        leg_list_3p_K1, leg_list_3p_K2, leg_list_3p_K12 = self.get_sector_filtering(
        ...
        leg_list_4p_K1, leg_list_4p_K2, leg_list_4p_K12 = self.get_sector_filtering(
            ...
            for label in s['K1']:
                if label != 0:
                    if label == 'S_g':
                        ...
                        item_keys.append(('K1', tuple(set([s['ids'][0], s['ids'][1]])), label))

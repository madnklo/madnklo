...
# gl
                ...
                #if (i['id'] != 21 and j['id'] == 21 and len(ijlist) == 0):
                if (len(ijlist) == 0): 
                ...
                for ij in ijlist:
                    ...
                    for k, col_k in zip(leglist, colorlist):
                        ...
                        #if (ij['id'] != 21 and k['id'] == 21 and len(ijklist) == 0):
                        if (len(ijklist) == 0):
...
# gl
                ...
                for k, col_k in zip(leglist, colorlist):
                    ...
                    for l, col_l in zip(leglist, colorlist):
                        ...
                        #if (k['id'] != 21 and l['id'] == 21 and len(kllist) == 0):
                        if (len(kllist) == 0):
                        ...
                        if len(fourp_sectors) == 0 or tmp_sector not in combs:
                            ...
                            # TO BE IMPLEMENTED
                            #a_sector['recoiler'] = recoiler_function.get_recoiler(defining_process,(i.get('number'),j.get('number'),k.get('number'),l.get('number')))
        ...
        for s in all_3p_sectors:
            ...
            if counterterms is not None:
                ...
                for i_ct, ct in enumerate(counterterms):
                        ...
                        if not singular_structure.substructures:
                            ...
                            if sorted([l.n for l in all_legs]) == (sorted([ileg,jleg])):
                                ...
                                if s['sector'].id[0] == 21 and s['sector'].id[1] == 21:
                                    ...
                                    ordered_legs_3p_K1_ct[1] = ('isec,jsec')
                                #elif s['sector'].id[0] == 21 and s['sector'].id[1] != 21:
                                elif (sorted([i_id, j_id]).count(21) == 1):
                                    necessary_3p_ct1_list[1] = 'C_gq'
                                    ordered_legs_3p_K1_ct[1] = ('isec,jsec') if s['sector'].id[0] == 21 else ('jsec,isec')
                                else :
                    ...
                    ordered_legs_3p_K1_ct[2] = ordered_legs_3p_K1_ct[1] if (necessary_3p_ct1_list[0] != 0 and necessary_3p_ct1_list[1] != 0) else 0
                    ...
                    if (label == 'ijjk'):
                            ...
                            if singular_structure.name()=='S' and len(all_legs)==2:
                                if not singular_structure.substructures:
                                    ...
                                    if sorted([l.n for l in all_legs]) == sorted([ileg,jleg]):
                                        ...
                                        ordered_legs_3p_K2_ct[0] = ('isec,jsec')
                            ...
                            if singular_structure.name()=='C' and len(all_legs)==3:
                                ...
                                if sorted([l.n for l in all_legs]) == sorted([ileg,jleg,kleg]):
                                    ...
                                    if (i_id == 21 and j_id == 21 and k_id == 21):
                                        ...
                                        ordered_legs_3p_K2_ct[3] = ('isec,jsec,ksec')
                                    #elif (i_id == 21 and j_id == 21 and k_id != 21):
                                    elif (sorted([i_id,j_id,k_id]).count(21) == 2):
                                        necessary_3p_ct2_list[3] = 'CC_ggq'
                                        if (k_id != 21):
                                            ordered_legs_3p_K2_ct[3] = ('isec,jsec,ksec')
                                        elif (i_id != 21):
                                            ordered_legs_3p_K2_ct[3] = ('jsec,ksec,isec')
                                        elif (j_id != 21):
                                            ordered_legs_3p_K2_ct[3] = ('isec,ksec,jsec')
                                    #elif (i_id == 21 and j_id != 21 and  j_id == (- k_id)):
                                    elif (sorted([i_id,j_id,k_id]).count(21) == 1):
                                        necessary_3p_ct2_list[3] = 'CC_gqqx'
                                        if (k_id == 21):
                                            ordered_legs_3p_K2_ct[3] = ('ksec,isec,jsec') 
                                        elif (i_id == 21):
                                            ordered_legs_3p_K2_ct[3] = ('isec,jsec,ksec')
                                        elif (j_id == 21):
                                            ordered_legs_3p_K2_ct[3] = ('jsec,isec,ksec')
                                    else:
                        ...
                        if len(n_subs) == 2 :
                            ...
                            if (i_id == 21 and sorted([l.n for l in all_legs_C]) == sorted([jleg,kleg])) :
                                ...
                                if (j_id == 21 and k_id == 21):
                                    ...
                                    ordered_legs_3p_K2_ct[1] = ('isec,jsec,ksec')
                                #elif (j_id == 21 and k_id != 21):
                                elif (sorted([j_id,k_id]).count(21) == 1):
                                    necessary_3p_ct2_list[1] = 'SC_ggq'
                                    ordered_legs_3p_K2_ct[1] = ('isec,jsec,ksec') if j_id == 21 else ('isec,ksec,jsec') 
                                else:
                        ...
                        ordered_legs_3p_K2_ct[2] = ordered_legs_3p_K2_ct[1] if (necessary_3p_ct2_list[0] != 0 and necessary_3p_ct2_list[1] != 0) else 0
                        # SijCijk
                        ...
                        ordered_legs_3p_K2_ct[4] = ordered_legs_3p_K2_ct[3] if (necessary_3p_ct2_list[0] != 0 and necessary_3p_ct2_list[3] != 0) else 0
                        # SCijkCijk
                        ...
                        ordered_legs_3p_K2_ct[5] = ordered_legs_3p_K2_ct[3] if (necessary_3p_ct2_list[1] != 0 and necessary_3p_ct2_list[3] != 0) else 0
                        # SijSCijkCijk
                        ...
                        ordered_legs_3p_K2_ct[6] = ordered_legs_3p_K2_ct[3] if (necessary_3p_ct2_list[0] != 0 and necessary_3p_ct2_list[1] != 0 and necessary_3p_ct2_list[3] != 0) else 0
                                ...
                                if not singular_structure.substructures:
                                    ...
                                    if sorted([l.n for l in all_legs]) == sorted([ileg,kleg]):
                                        ...
                                        if (i_id == 21 and k_id == 21):
                                            ...
                                            necessary_3p_ct2_list[0] =  'SS_qqx'
                                        necessary_3p_ct2[0] = ct
                                        ordered_legs_3p_K2_ct[0] = ('isec,ksec') 
                            ...
                            if singular_structure.name()=='C' and len(all_legs)==3:
                                ...
                                if sorted([l.n for l in all_legs]) == sorted([ileg,jleg,kleg]):
                                    ...
                                    if (i_id == 21 and j_id == 21 and k_id == 21):
                                        ...
                                        ordered_legs_3p_K2_ct[5] = ('isec,jsec,ksec')
                                    #elif (i_id == 21 and j_id == 21 and k_id != 21):
                                    elif (sorted([i_id,j_id,k_id]).count(21) == 2):
                                        ...
                                        if (k_id != 21):
                                            ...
                                            ordered_legs_3p_K2_ct[5] = ('jsec,ksec,isec') 
                                        elif (j_id != 21):
                                            ordered_legs_3p_K2_ct[5] = ('isec,ksec,jsec') 
                                    #elif (i_id == 21 and j_id != 21 and  j_id == (- k_id)):
                                    elif (sorted([i_id,j_id,k_id]).count(21) == 1):
                                        necessary_3p_ct2_list[5] = 'CC_gqqx'
                                        if (k_id == 21):
                                            ordered_legs_3p_K2_ct[5] = ('ksec,isec,jsec')
                                        elif (i_id == 21):
                                            ordered_legs_3p_K2_ct[5] = ('isec,jsec,ksec') 
                                        elif (j_id == 21):
                                            ordered_legs_3p_K2_ct[5] = ('jsec,isec,ksec') 
                                    else:
                                        if abs(i_id) == abs(j_id) and abs(j_id) == abs(k_id):
                        ...
                        if len(n_subs) == 2 :
                            ...
                            if (k_id == 21 and sorted([l.n for l in all_legs_C]) == sorted([ileg,jleg])) :
                                ...
                                if (i_id == 21 and j_id == 21):
                                    ...
                                    ordered_legs_3p_K2_ct[2] = ('ksec,isec,jsec') 
                                #elif (i_id == 21 and j_id != 21):
                                elif (sorted([i_id,j_id]).count(21) == 1):
                                    necessary_3p_ct2_list[2] = 'SC_ggq'
                                    ordered_legs_3p_K2_ct[2] = ('ksec,isec,jsec') if i_id == 21 else ('ksec,jsec,isec')
                                else:
                        ...
                        ordered_legs_3p_K2_ct[4] = ordered_legs_3p_K2_ct[2]
                        # SikCijk
                        ...
                        ordered_legs_3p_K2_ct[6] = ('isec,ksec,jsec')
                        # SCijkCijk
                        ...
                        ordered_legs_3p_K2_ct[7] = ordered_legs_3p_K2_ct[1]
                        # SikSCijkCijk
                        ...
                        ordered_legs_3p_K2_ct[8] = ordered_legs_3p_K2_ct[1]
                        # SCkijCijk
                        ...
                        ordered_legs_3p_K2_ct[9] = ordered_legs_3p_K2_ct[2]
                        # SikSCkijCijk
                        ...
                        ordered_legs_3p_K2_ct[10] = ordered_legs_3p_K2_ct[2]
                    ...
                    if (label == 'ijjk'):
                        ...
                        ordered_legs_3p_K12_ct[0] = ordered_legs_3p_K2_ct[0]
                        # Si SCijk
                        ...
                        ordered_legs_3p_K12_ct[1] = ordered_legs_3p_K2_ct[1]
                        # Si SijSCijk
                        ...
                        ordered_legs_3p_K12_ct[2] = ordered_legs_3p_K2_ct[2]
                        # Si Cijk
                        ...
                        ordered_legs_3p_K12_ct[3] = ordered_legs_3p_K2_ct[3]
                        # Si SijCijk
                        ...
                        ordered_legs_3p_K12_ct[4] = ordered_legs_3p_K2_ct[4]
                        # Si SCijkCijk
                        ...
                        ordered_legs_3p_K12_ct[5] = ordered_legs_3p_K2_ct[5]
                        # Si SijSCijkCijk
                        ...
                        ordered_legs_3p_K12_ct[6] = ordered_legs_3p_K2_ct[6]
                        # Cij Sij
                        ...
                        ordered_legs_3p_K12_ct[7] = ordered_legs_3p_K1_ct[1]
                        # Cij Cijk
                        ...
                        ordered_legs_3p_K12_ct[8] = ordered_legs_3p_K2_ct[3]
                        # Cij SijCijk
                        ...
                        ordered_legs_3p_K12_ct[9] = ordered_legs_3p_K2_ct[4]
                        # SiCij Sij
                        ...
                        ordered_legs_3p_K12_ct[10] = ordered_legs_3p_K1_ct[1]
                        # SiCij Cijk
                        ...
                        ordered_legs_3p_K12_ct[11] = ordered_legs_3p_K2_ct[3]
                        # SiCij SijCijk
                        ...
                        ordered_legs_3p_K12_ct[12] = ordered_legs_3p_K2_ct[4]
                        ...
                        necessary_3p_ct12_list[2] = (''.join(('S_',necessary_3p_ct2_list[3])) \
                                                 if (necessary_3p_ct1_list[0] != 0 and necessary_3p_ct2_list[3] != 0) else 0)
                        ordered_legs_3p_K12_ct[2] = ordered_legs_3p_K2_ct[3]
                        # Si Cijk
                        necessary_3p_ct12_list[3] = (''.join(('S_',necessary_3p_ct2_list[5])) \
                                                 if (necessary_3p_ct1_list[0] != 0 and necessary_3p_ct2_list[5] != 0) else 0)
                        ordered_legs_3p_K12_ct[3] = ordered_legs_3p_K2_ct[5]
                        # Si SikCijk
                        necessary_3p_ct12_list[4] = (''.join(('S_',necessary_3p_ct2_list[6])) \
                                                 if (necessary_3p_ct1_list[0] != 0 and necessary_3p_ct2_list[6] != 0) else 0)
                        ordered_legs_3p_K12_ct[4] = ordered_legs_3p_K2_ct[6]
                        # Si SCijkCijk
                        ...
                        ordered_legs_3p_K12_ct[5] = ordered_legs_3p_K2_ct[7]
                        # Si SikSCijkCijk
                        ...
                        ordered_legs_3p_K12_ct[6] = ordered_legs_3p_K2_ct[8]
                        # Cij SCkij
                        ...
                        ordered_legs_3p_K12_ct[7] = ordered_legs_3p_K2_ct[2]
                        # Cij Cijk
                        ...
                        ordered_legs_3p_K12_ct[8] = ordered_legs_3p_K2_ct[5]
                        # Cij SCkijCijk
                        ...
                        ordered_legs_3p_K12_ct[9] = ordered_legs_3p_K2_ct[9]
                        # SiCij SCkij
                        ...
                        ordered_legs_3p_K12_ct[10] = ordered_legs_3p_K2_ct[2]
                        # SiCij Cijk
                        ...
                        ordered_legs_3p_K12_ct[11] = ordered_legs_3p_K2_ct[5]
                        # SiCij SCkijCijk
                        ...
                        ordered_legs_3p_K12_ct[12] = ordered_legs_3p_K2_ct[9]
                ...
                leg_list_3p_K1.append(ordered_legs_3p_K1_ct)

                print('K2 3p sector')
                print(necessary_3p_ct2_list)
                all_3p_K2_ct.append(necessary_3p_ct2_list)
                uB_all_3p_K2_ct.append(necessary_3p_ct2)
                leg_list_3p_K2.append(ordered_legs_3p_K2_ct)

                print('K12 3p sector')
                print(necessary_3p_ct12_list)
                all_3p_K12_ct.append(necessary_3p_ct12_list)
                leg_list_3p_K12.append(ordered_legs_3p_K12_ct)

        # Apply selection rule to sector list
        saved_filtering_list = set()
        all_3p_sector_list, all_3p_sector_id_list, all_3p_sector_recoilers, \
        all_3p_K1_ct, all_3p_K2_ct, all_3p_K12_ct, uB_all_3p_K1_ct, uB_all_3p_K2_ct, \
        leg_list_3p_K1, leg_list_3p_K2, leg_list_3p_K12, saved_filtering_list = self.get_sector_filtering(
                all_3p_sector_list, all_3p_sector_id_list, all_3p_sector_recoilers, all_3p_K1_ct, all_3p_K2_ct, all_3p_K12_ct, \
                uB_all_3p_K1_ct, uB_all_3p_K2_ct, leg_list_3p_K1, leg_list_3p_K2, leg_list_3p_K12, True, saved_filtering_list)
        ...
        for s in all_4p_sectors:
            ...
            if counterterms is not None:
                ...
                for i_ct, ct in enumerate(counterterms):
                        ...
                        if not singular_structure.substructures:
                            ...
                            if sorted([l.n for l in all_legs]) == (sorted([ileg,jleg])):
                                ...
                                if (i_id == 21 and j_id == 21):
                                    ...
                                    ordered_legs_4p_K1_ct[1] = ('isec,jsec')
                                #elif (i_id == 21 and j_id != 21):
                                elif (sorted([i_id,j_id]).count(21) == 1):
                                    necessary_4p_ct1_list[1] = 'C_gq'
                                    ordered_legs_4p_K1_ct[1] = ('isec,jsec') if (i_id == 21) else ('jsec,isec')
                                else :
                    ...
                    ordered_legs_4p_K1_ct[2] = ordered_legs_4p_K1_ct[1]
                    ...
                    if len(n_subs) == 1 and len(singular_structure.substructures) == 0 :
                        ...
                        if singular_structure.name()=='S' and len(all_legs)==2:
                            ...
                            if sorted([l.n for l in all_legs]) == sorted([ileg,kleg]):
                                ...
                                ordered_legs_4p_K2_ct[0] = ('isec,ksec')
                        ...
                        if n_subs[0].name()=='S' and n_subs[1].name()=='C':
                            ...
                            if i_id == 21 and sorted([l.n for l in n_subs[1].get_all_legs()]) == (sorted([kleg,lleg])):
                                if (k_id == 21 and l_id == 21):
                                    ...
                                    ordered_legs_4p_K2_ct[1] = ('isec,ksec,lsec')
                                #elif (k_id == 21 and l_id != 21):
                                elif (sorted([k_id,l_id]).count(21) == 1):
                                    necessary_4p_ct2_list[1] = 'SC_ggq'
                                    ordered_legs_4p_K2_ct[1] = ('isec,ksec,lsec') if (k_id == 21) else ('isec,lsec,ksec')
                                else:
                            ...
                            if k_id == 21 and sorted([l.n for l in n_subs[1].get_all_legs()]) == (sorted([ileg,jleg])):
                                if (i_id == 21 and j_id == 21):
                                    ...
                                    ordered_legs_4p_K2_ct[2] = ('ksec,isec,jsec')
                                #elif (i_id == 21 and j_id != 21):
                                elif (sorted([i_id,j_id]).count(21) == 1):
                                    necessary_4p_ct2_list[2] = 'SC_ggq'
                                    ordered_legs_4p_K2_ct[2] = ('ksec,isec,jsec') if (i_id == 21) else ('ksec,jsec,isec')
                                else:
                        ...
                        if n_subs[0].name()=='C' and n_subs[1].name()=='C':
                            if sorted([l.n for l in n_subs[0].get_all_legs()]) == (sorted([ileg,jleg])) and \
                                ...
                                if i_id == 21 and j_id == 21 and k_id == 21 and l_id == 21:
                                    ...
                                    ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec')
                                #elif i_id == 21 and j_id == 21 and k_id == 21 and l_id != 21:
                                elif i_id == 21 and j_id == 21 and sorted([k_id,l_id]).count(21) == 1:
                                    necessary_4p_ct2_list[5] = 'CC_gggq'
                                    ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec') if (k_id == 21) else ('isec,jsec,lsec,ksec')
                                #elif k_id == 21 and l_id == 21 and i_id == 21 and j_id != 21:
                                elif k_id == 21 and l_id == 21 and sorted([i_id,j_id]).count(21) == 1:
                                    necessary_4p_ct2_list[5] = 'CC_gqgg'
                                    ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec') if (i_id == 21) else ('jsec,isec,ksec,lsec')
                                elif i_id == 21 and j_id == 21 and k_id == -l_id:
                                    necessary_4p_ct2_list[5] = 'CC_ggqxq'
                                    ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec')
                                elif k_id == 21 and l_id == 21 and i_id == -j_id:
                                    necessary_4p_ct2_list[5] = 'CC_qxqgg'
                                    ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec')
                                #elif i_id == 21 and j_id != 21 and k_id == 21 and l_id != 21:
                                elif sorted([i_id,j_id]).count(21) == 1 and sorted([k_id,l_id]).count(21) == 1:
                                    necessary_4p_ct2_list[5] = 'CC_gqgq'
                                    if (i_id == 21):
                                        if (k_id == 21):
                                            ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec')
                                        else:
                                            ordered_legs_4p_K2_ct[5] = ('isec,jsec,lsec,ksec')
                                    else:
                                        if (k_id == 21):
                                            ordered_legs_4p_K2_ct[5] = ('jsec,isec,ksec,lsec')
                                        else:
                                            ordered_legs_4p_K2_ct[5] = ('jsec,isec,lsec,ksec')
                                #elif i_id == 21 and j_id != 21 and abs(k_id) == abs(l_id):
                                elif sorted([i_id,j_id]).count(21) == 1 and k_id == -l_id:
                                    necessary_4p_ct2_list[5] = 'CC_gqqxq'
                                    ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec') if (i_id == 21) else ('jsec,isec,ksec,lsec')
                                #elif k_id == 21 and l_id != 21 and abs(i_id) == abs(j_id):
                                elif i_id == -j_id and sorted([k_id,l_id]).count(21) == 1:
                                    necessary_4p_ct2_list[5] = 'CC_qxqgq'
                                    ordered_legs_4p_K2_ct[5] = ('isec,jsec,ksec,lsec') if (k_id == 21) else ('isec,jsec,lsec,ksec')
                                elif i_id == -j_id and k_id == -l_id:
                    ...
                    ordered_legs_4p_K2_ct[3] = ordered_legs_4p_K2_ct[1]
                    # SikSCkij
                    ...
                    ordered_legs_4p_K2_ct[4] = ordered_legs_4p_K2_ct[2]
                    # SikCijkl
                    ...
                    ordered_legs_4p_K2_ct[6] = ordered_legs_4p_K2_ct[5]
                    # SCiklCijkl
                    ...
                    ordered_legs_4p_K2_ct[7] = ordered_legs_4p_K2_ct[5]
                    # SCkijCijkl
                    ...
                    ordered_legs_4p_K2_ct[8] = ordered_legs_4p_K2_ct[5]
                    ...
                    ordered_legs_4p_K12_ct[0] = ordered_legs_4p_K2_ct[0]
                    # Si SCikl
                    ...
                    ordered_legs_4p_K12_ct[1] = ordered_legs_4p_K2_ct[1]
                    # Si SikSCikl
                    ...
                    ordered_legs_4p_K12_ct[2] = ordered_legs_4p_K2_ct[3]
                    # Cij SCkij
                    ...
                    ordered_legs_4p_K12_ct[3] = ordered_legs_4p_K2_ct[2]
                    # Cij Cijkl
                    ...
                    ordered_legs_4p_K12_ct[4] = ordered_legs_4p_K2_ct[5]
                    # Cij SCkijCijkl
                    ...
                    ordered_legs_4p_K12_ct[5] = ordered_legs_4p_K2_ct[8]
                    # SiCij SCkij
                    ...
                    ordered_legs_4p_K12_ct[6] = ordered_legs_4p_K2_ct[2]
                    # SiCij Cijkl
                    ...
                    ordered_legs_4p_K12_ct[7] = ordered_legs_4p_K2_ct[5]
                    # SiCij SCkijCijkl
                    ...
                    ordered_legs_4p_K12_ct[8] = ordered_legs_4p_K2_ct[8]
                ...
                leg_list_4p_K1.append(ordered_legs_4p_K1_ct)

                print('K2 4p sector')
                print(necessary_4p_ct2_list)
                all_4p_K2_ct.append(necessary_4p_ct2_list)
                uB_all_4p_K2_ct.append(necessary_4p_ct2)
                leg_list_4p_K2.append(ordered_legs_4p_K2_ct)

                print('K12 4p sector')
                print(necessary_4p_ct12_list)
                all_4p_K12_ct.append(necessary_4p_ct12_list)
                leg_list_4p_K12.append(ordered_legs_4p_K12_ct)

        # Apply selection rule to sector list
        all_4p_sector_list, all_4p_sector_id_list, all_4p_sector_recoilers, \
        all_4p_K1_ct, all_4p_K2_ct, all_4p_K12_ct, uB_all_4p_K1_ct, uB_all_4p_K2_ct, \
        leg_list_4p_K1, leg_list_4p_K2, leg_list_4p_K12, saved_filtering_list = self.get_sector_filtering(
                all_4p_sector_list, all_4p_sector_id_list, all_4p_sector_recoilers, all_4p_K1_ct, all_4p_K2_ct, all_4p_K12_ct, \
                uB_all_4p_K1_ct, uB_all_4p_K2_ct, leg_list_4p_K1, leg_list_4p_K2, leg_list_4p_K12, False, saved_filtering_list)
            ...
            for j in range(0, len(all_3p_K1_ct[i])):
                ...
                if j == 0: # S_i
                    list_str_M2_K1.append('K%s=K%s+M2_%s(%s,xs,xp,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % (all_3p_K1_ct[i][j].split("_")[0], all_3p_K1_ct[i][j].split("_")[0], all_3p_K1_ct[i][j], leg_list_3p_K1[i][j]))
                    ...
                    list_str_M2_K1.append('K%s=K%s+M2_%s(%s,xs,xp,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % ('SC', 'SC', all_3p_K1_ct[i][j], leg_list_3p_K1[i][j]))
                    list_str_M2_K1.append('if(ierr.eq.1)goto 999\n')
                    os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K1_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
                ...
                for j in range(0, len(all_3p_K2_ct[i])):
                    ...
                    if j == 0: # SS_ij
                        list_str_M2_K2.append('K%s=K%s+M2_%s(%s,xs,xp,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                           % ('SS', 'SS', all_3p_K2_ct[i][j], leg_list_3p_K2[i][j]))
                        ...
                        list_str_M2_K2.append('K%s=K%s+M2_%s(%s,iref,xs,xp,xsb,xpb,xsbb,xpbb,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                           % ('SC', 'SC', all_3p_K2_ct[i][j], leg_list_3p_K2[i][j]))
                        list_str_M2_K2.append('if(ierr.eq.1)goto 999\n')
                        os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K2_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
                        ...
                        list_str_M2_K2.append('K%s=K%s+M2_%s(%s,iref,xs,xp,xsb,xpb,xsbb,xpbb,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                           % ('CC', 'CC', all_3p_K2_ct[i][j], leg_list_3p_K2[i][j]))
                        list_str_M2_K2.append('if(ierr.eq.1)goto 999\n')
                        os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K2_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
                ...
                for j in range(0, len(all_3p_K12_ct[i])):
                    ...
                    if j == 0:    # S_i SS_ij
                        list_str_M2_K12.append('K%s=K%s+M2_%s(%s,iref,xs,xp,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % ('S_SS', 'S_SS', all_3p_K12_ct[i][j], leg_list_3p_K12[i][j]))
                        ...
                        list_str_M2_K12.append('K%s=K%s+M2_%s(%s,iref,xs,xp,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % ('S_SC', 'S_SC', all_3p_K12_ct[i][j], leg_list_3p_K12[i][j]))
                        list_str_M2_K12.append('if(ierr.eq.1)goto 999\n')
                        os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K12_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
                        ...
                        list_str_M2_K12.append('K%s=K%s+M2_%s(%s,iref,xs,xp,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % ('S_CC', 'S_CC', all_3p_K12_ct[i][j], leg_list_3p_K12[i][j]))
                        list_str_M2_K12.append('if(ierr.eq.1)goto 999\n')
                        os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K12_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
                        ...
                        list_str_M2_K12.append('K%s=K%s+M2_%s(%s,iref,xs,xp,xsb,xpb,xsbb,xpbb,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % ('HC_SS', 'HC_SS', all_3p_K12_ct[i][j], leg_list_3p_K12[i][j]))
                        list_str_M2_K12.append('if(ierr.eq.1)goto 999\n')
                        os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K12_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
                    elif j == 8:  # + C_ij CC_ijk
                        list_str_M2_K12.append('K%s=K%s+M2_%s(%s,iref,xs,xp,xsb,xpb,xsbb,xpbb,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % ('HC_CC', 'HC_CC', all_3p_K12_ct[i][j], leg_list_3p_K12[i][j]))
                        list_str_M2_K12.append('if(ierr.eq.1)goto 999\n')
                        os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K12_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
...
c       KHC_CC = C_ij (1-S_i) CC_ijk (1 - SC_kij)"""
                ...
                for j in range(0, len(all_3p_K12_ct[i])):
                    ...
                    if j == 0:    # S_i SS_ik
                        ...
                        list_str_M2_K12.append('K%s=K%s+M2_%s(%s,iref,xs,xp,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
                                       % ('HC_SC', 'HC_SC', all_3p_K12_ct[i][j], leg_list_3p_K12[i][j]))
                        list_str_M2_K12.append('if(ierr.eq.1)goto 999\n')
                        os.system('cat ' + NNLO_IR_limits_tmp_path + all_3p_K12_ct[i][j] + '.f >> ' + NNLO_IR_limits_tmp_path + 'IR_tmp.f')
                    elif j == 8:  # + C_ij CC_ijk
                        list_str_M2_K12.append('K%s=K%s+M2_%s(%s,iref,xs,xp,xsb,xpb,xsbb,xpbb,wgt,xj,xjB,nitRR,1d0,wgt_chan,ierr)\n'
...
#             # print('  ')
            ...
            # write NNLO_IR_limits # DEBUG ERROR
...
######### Link Born & Real files to each real process directory
    ...
    #===========================================================================
    # Sort particle indices according to pgds for kernels
    #===========================================================================
    ...
    def sort_id(pairs):
        ...
        sorted_pairs = sorted(pairs, key=lambda x: rank(x[0]))

        return ",".join(name for _, name in sorted_pairs)

    #===========================================================================
    # filtering function applying selection rule to sectors
    #===========================================================================

    def get_sector_filtering(self, sector_list, sector_id_list, sector_recoilers_list, K1_ct_list, K2_ct_list, K12_ct_list, \
                             uB_K1, uB_K2, order_leg_K1, order_leg_K2, order_leg_K12, flag, saved_list):

        if (flag == True):
           seen_global_elements = set()
           saved_list = set()
        else:   
           seen_global_elements = saved_list
        #seen_global_elements = set()
        selected_sectors = []
        combined = []

        # Tie sectors to their ct lists
        for i in range(len(sector_list)):
            sector_ids = list(zip(sector_list[i], sector_id_list[i]))
            print(sector_ids)
            combined.append({
                'ids': sector_ids,
                'K1': K1_ct_list[i],
                'K2': K2_ct_list[i],
                'K12': K12_ct_list[i],
                'original_pos': sector_list[i],
                'original_pdg': sector_id_list[i],
                'recoilers' : sector_recoilers_list[i],
                'uB_K1' : uB_K1[i],
                'uB_K2' : uB_K2[i],
                'order_leg_K1' : order_leg_K1[i],
                'order_leg_K2' : order_leg_K2[i],
                'order_leg_K12' : order_leg_K12[i]
        })
            
        def count_ct(s):
            return sum(1 for label in s['K1'] + s['K2'] + s['K12'] if label != 0)

        # Order sector according to # of required cts
        combined.sort(key=count_ct, reverse=True)

        for s in combined:

            item_keys = []

            #K1_key = tuple(sorted(set([s['ids'][0], s['ids'][1]])))
            K1_key = tuple(sorted(set([s['ids'][0], s['ids'][1]])))
            for label in s['K1']:
                if label != 0:
                    if label == 'S_g':
                        #item_keys.append(('K1', tuple(sorted(set([s['ids'][0]]))), label))
                        item_keys.append(('K1', tuple(set([s['ids'][0]])), label))
                        print(('K1', tuple(sorted(set([s['ids'][0]]))), label))
                    else:
                        item_keys.append(('K1', K1_key, label))
                        print(('K1', K1_key, label))

            #K2_K12_key = tuple(sorted(set(s['ids'])))  
            i = -1    
            label_leg = ['isec', 'jsec', 'ksec', 'lsec']
            full_map = dict(zip(label_leg, s['ids']))
            for label in s['K2']:
                i = i+1
                if label != 0:
                    if label == 'SS_gg' or label == 'SS_qqx':
                        if (len({x[0] for x in sector_ids}) == len(sector_ids)):
                            K2_K12_key = tuple(set(full_map[lbl] for lbl in s['order_leg_K2'][i].split(",")))
                        else:
                            K2_K12_key = tuple(set(full_map[lbl] for lbl in s['order_leg_K2'][i].split(","))) #tuple(set(s['ids']))
                        item_keys.append(('K2', K2_K12_key, label))
                        print(('K2', K2_K12_key, label))
                    else:           
                        if (len({x[0] for x in sector_ids}) == len(sector_ids)):
                            K2_K12_key = tuple(set(full_map[lbl] for lbl in s['order_leg_K2'][i].split(",")))  
                        else:
            ...
            for label in s['K12']:
                i = i+1
                if label != 0:
                    if label == 'S_SS_gg' or label == 'S_SS_qqx':
                        if (len({x[0] for x in sector_ids}) == len(sector_ids)):
                            K2_K12_key = tuple(set(full_map[lbl] for lbl in s['order_leg_K12'][i].split(",")))
                        else:
                            K2_K12_key = tuple(set(full_map[lbl] for lbl in s['order_leg_K12'][i].split(","))) #tuple(set(s['ids']))
                        item_keys.append(('K12', K2_K12_key, label))
                        print(('K12', K2_K12_key, label))
                    else:
                        if (len({x[0] for x in sector_ids}) == len(sector_ids)):
                            K2_K12_key = tuple(set(full_map[lbl] for lbl in s['order_leg_K12'][i].split(",")))
                        else:
            ...
            # Check if all item are already present in item_keys
            is_redundant = all(item in seen_global_elements for item in item_keys)

            # Remove 4p sectors with only single-unresolved limits
            #if (len({x[0] for x in sector_ids}) == len(sector_ids) and all(key == 'K1' for key, _, _ in item_keys)):
            #    is_redundant = True

            if not is_redundant:
                selected_sectors.append(s)
                print('Selected sector : ' + str(s['original_pos']))
                for item in item_keys:
                    seen_global_elements.add(item)
            else:
                print('Removed sector  : ' + str(s['original_pos']))

        # Return surviving&ordered sector info
        new_sector_list = [s['original_pos'] for s in selected_sectors]
        new_id_list = [s['original_pdg'] for s in selected_sectors]
    
        new_K1_list = [s['K1'] for s in selected_sectors]
        new_K2_list = [s['K2'] for s in selected_sectors]
        new_K12_list = [s['K12'] for s in selected_sectors]
        new_recoiler_list = [s['recoilers'] for s in selected_sectors]
        new_uB_K1 = [s['uB_K1'] for s in selected_sectors]
        new_uB_K2 = [s['uB_K2'] for s in selected_sectors]
        new_order_leg_K1 = [s['order_leg_K1'] for s in selected_sectors]
        new_order_leg_K2 = [s['order_leg_K2'] for s in selected_sectors]
        new_order_leg_K12 = [s['order_leg_K12'] for s in selected_sectors]

        saved_list = seen_global_elements

        return new_sector_list, new_id_list, new_recoiler_list, new_K1_list, new_K2_list, new_K12_list, \
            new_uB_K1, new_uB_K2, new_order_leg_K1, new_order_leg_K2, new_order_leg_K12, saved_list

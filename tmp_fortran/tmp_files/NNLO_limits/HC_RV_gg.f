...
c     call Born and spin-correlated Born
      call %(proc_prefix_HC_RV_gg)s_ME_ACCESSOR_HOOK(xpb,hel,alphas,ANS)
      BLO = ANS(0)
      KKBLO = %(proc_prefix_HC_RV_gg)s_GET_KKBLO(parent_leg,xpb,kt)
c     call Virtual and spin-correlated Virtual
      call %(proc_prefix_HC_RV_gg)s_ME_ACCESSOR_HOOK(xpb,hel,alphas,ANS)
      VLO = ANS(0)
      KKVLO = %(proc_prefix_HC_RV_gg)s_GET_KKVLO(parent_leg,xpb,kt)
c

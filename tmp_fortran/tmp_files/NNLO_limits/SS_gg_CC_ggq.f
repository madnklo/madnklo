...
c     safety check
      if(sij.lt.0d0.or.sik.lt.0d0.or.sjk.lt.0d0.or.zj.lt.0d0.or.zk.lt.0d0)then
        write(77,*)'Inaccuracy 1 in M2_SS_gg_CC_ggq',sij,sik,sjk,zj,zk
        goto 999
      endif

c     double-soft double-collinear sector function, (C.60-61) of 2212.11190
...
c     call Born matrix element
      ...
      BLO = ANS(0)
c
c     double-soft double-collinear kernel, (C.16)
      Ei_kr = skr/sik/sir
      Ej_kr = skr/sjk/sjr

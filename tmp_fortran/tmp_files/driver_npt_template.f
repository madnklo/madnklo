...
c     number of points thrown per channel in the main loop
      ...
      do i=1,N_MAX_CG
         ...
         init=0
         doplot=.false.
         call vegas(region,ndim,int_double_real_%(isec)d_%(jsec)d_%(c3p)d_%(d3p)d,init,nclRRth0,nitRRth0,nprn,res_rr,err_rr,chi2a,acc,xi,it,ndo,si,swgt,schi)
         err_rr_a(ich) = err_rr
...
c     main loop over channels
      do i=1,N_MAX_CG
         ...
         call vegas(region,ndim,int_double_real_%(isec)d_%(jsec)d_%(c3p)d_%(d3p)d,init,nclRRth1,nitRRth,nprn,res_rr,err_rr,chi2a,acc,xi,it,ndo,si,swgt,schi)
...
c
         ...
         call vegas(region,ndim,int_double_real_%(isec)d_%(jsec)d_%(c3p)d_%(d3p)d,init,nclRR1,nitRR,nprn,res_rr,err_rr,chi2a,acc,xi,it,ndo,si,swgt,schi)
